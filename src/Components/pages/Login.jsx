    ...
    return (
        <div className='flex mb-52 flex-col lg:flex-row h-screen'>
            <div className='w-[80%] mx-auto lg:w-[50%] mt-16 '>
                <h1 className="text-2xl font-bold text-center text-orange-500 my-5">Log in to your account</h1>
                <div className='w-full lg:w-[50%] mx-auto '>
                    <form onSubmit={handleLogin} className='space-y-10'>
                        ...
                        <button className='btn w-full text-white bg-orange-500 '>Log in <FiLogIn className='text-xl'></FiLogIn></button>
                    </form>
                    < hr className='my-5' />
                    <button onClick={handleGoogle} className='btn w-full text-white bg-orange-500 '>Log in with <FcGoogle className='text-xl'></FcGoogle></button>
